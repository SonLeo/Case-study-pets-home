                            ...
                            <ul className={styles.socials}>
                                <li className={styles.social} title="Facebook">
                                    <Link target="_blank" href='https://www.facebook.com/petshomevn'>
                                        <img className={styles['social-icon']} src="/assets/icons/Facebook-white.svg" />
                                    </Link>
                                </li>
                                <li className={styles.social} title="Twitter">
                                    <Link target="_blank" href='#'>
                                        <img className={styles['social-icon']} src="/assets/icons/Twitter-white.svg" />
                                    </Link>
                                </li>
